...
def assert_is_template(*parts: Part):
    for part in parts:
        assert part.circuit is None, \
            "Expected part parameter to be a template: {}".format(part)


# Source: https://en.wikipedia.org/wiki/E_series_of_preferred_numbers#Lists
# 2019-05-07
RESISTOR_SERIES = {
    'E1': {1.0},
    'E3': {1.0, 2.2, 4.7},
    ...
    'E192': {1.00, 1.01, 1.02, 1.04, 1.05, 1.06, 1.07, 1.09, 1.10, 1.11, 1.13,
...
RESISTOR_SERIES['E48+E24'] = RESISTOR_SERIES['E48'] | RESISTOR_SERIES['E24']
RESISTOR_SERIES['E96+E24'] = RESISTOR_SERIES['E96'] | RESISTOR_SERIES['E24']
RESISTOR_SERIES['E192+E24'] = RESISTOR_SERIES['E192'] | RESISTOR_SERIES['E24']

DECADES = [10**e for e in range(-3, 6)]
